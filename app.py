...
# Fungsi untuk membuat konten dalam kotak scrollable
def display_scrollable_box(content_func):
    with st.expander("Klik untuk melihat konten"):
        with st.container():
            content_func()
...
# Menu kedua: Data Info dan Statistik
    ...
    def data_info_and_statistics():
        ...
        st.pyplot(fig)
    display_scrollable_box(data_info_and_statistics)
...
# Menu ketiga: Stage 1
    ...
    display_scrollable_box(stage_1)
