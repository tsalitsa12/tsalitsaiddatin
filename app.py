...
selection = st.sidebar.selectbox("Choose a section", ["Data Description", "Stage 1", "Stage 2", "Stage 3"])

if selection == "Data Description":
    st.title('Restaurant Menu Optimization')
    st.write("## Data Description")
    st.write("Deskripsi dari data yang digunakan di sini.")
    # Input untuk deskripsi data jika diperlukan
    # Contoh deskripsi data
    st.write("Dataset ini mencakup informasi tentang menu restoran dengan fitur-fitur berikut:")
    st.write("- RestaurantID: ID unik restoran")
    st.write("- MenuCategory: Kategori menu")
    st.write("- MenuItem: Nama item menu")
    st.write("- Ingredients: Bahan-bahan")
    st.write("- Price: Harga")
    st.write("- Profitability: Profitabilitas")

elif selection == "Stage 1":
    st.title('Stage 1: Data Exploration')
    st.write("## Dataset")
    st.write(data)
...
elif selection == "Stage 2":
    st.title('Stage 2: Data Preprocessing')
...
elif selection == "Stage 3":
    st.title('Stage 3: Model Evaluation and Tuning')
    st.write("## Stage 3: Model Evaluation")
